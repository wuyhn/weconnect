package com.example.weconnect.presentation.main;
...
import com.example.weconnect.presentation.search.SearchActivity;
...
import com.example.weconnect.data.network.NotificationApiService;
...
import com.example.weconnect.data.repository.FakeChatRepository;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (realName != null && !realName.isEmpty()) {
            FakeSocialRepository.getInstance().setCurrentUsername(realName);
    ...
    private void syncInterestsFromBackend() {
        ...
        userApi.getInterests().enqueue(new Callback<ApiResponse<java.util.List<String>>>() {
            @Override
            public void onResponse(Call<ApiResponse<java.util.List<String>>> call,
                                   Response<ApiResponse<java.util.List<String>>> response) {
            ...
            @Override
            public void onFailure(Call<ApiResponse<java.util.List<String>>> call, Throwable t) {
    ...
    private void loadUnreadNotificationCount() {
        ...
        NotificationApiService notifApi =
                RetrofitClient.getClient().create(NotificationApiService.class);
    ...
    private void loadUnreadCountFallback() {
        ...
        notifApi.getNotifications().enqueue(new Callback<ApiResponse<java.util.List<NotificationItem>>>() {
            @Override
            public void onResponse(Call<ApiResponse<java.util.List<NotificationItem>>> call,
                                   Response<ApiResponse<java.util.List<NotificationItem>>> response) {
                if (response.isSuccessful() && response.body() != null
                        && response.body().getResult() != null) {
                    int count = 0;
                    for (NotificationItem item : response.body().getResult()) {
            ...
            @Override
            public void onFailure(Call<ApiResponse<java.util.List<NotificationItem>>> call, Throwable t) {}
        });
    }
        ...
        postApiService.createPost(body).enqueue(new Callback<ApiResponse<PostResponse>>() {
            ...
            public void onResponse(Call<ApiResponse<PostResponse>> call,
                ...
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                    ...
                    FakeChatRepository.getInstance()
    ...
    private void loadFriendNamesFromBackend() {
        ...
        friendApi.getFriends().enqueue(new Callback<ApiResponse<java.util.List<java.util.Map<String, Object>>>>() {
            @Override
