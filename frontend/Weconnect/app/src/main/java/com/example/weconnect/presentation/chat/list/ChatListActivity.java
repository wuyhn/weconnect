package com.example.weconnect.presentation.chat.list;
...
import com.example.weconnect.presentation.chat.adapter.ChatRoomAdapter;
import com.example.weconnect.data.network.ChatApiService;
    ...
    private List<ChatRoom> parseRooms(List<Map<String, Object>> data) {
        ...
        for (Map<String, Object> item : data) {
            try {
                ...
                List<com.example.weconnect.data.model.ChatMessage> messages = new ArrayList<>();
                if (!lastPreview.isEmpty() && !"Chưa có tin nhắn".equals(lastPreview)) {
                    // Format time
                    String formattedTime = formatTime(lastTime);
                    messages.add(new com.example.weconnect.data.model.ChatMessage(
    ...
    private void showNewChatDialog() {
        ...
        friendApi.getFriends().enqueue(new Callback<ApiResponse<List<Map<String, Object>>>>() {
            ...
            public void onFailure(Call<ApiResponse<List<Map<String, Object>>>> call, Throwable t) {
                ...
                for (String name : FakeSocialRepository.getInstance().getFriendNames()) {
        ...
        btnCreate.setOnClickListener(v -> {
            ...
            if (selectedFriends.size() == 1) {
                ...
                sheet.dismiss();
                com.example.weconnect.data.model.ChatRoom directRoom =
                ...
                sheet.dismiss();
                com.example.weconnect.data.model.ChatRoom groupRoom =
