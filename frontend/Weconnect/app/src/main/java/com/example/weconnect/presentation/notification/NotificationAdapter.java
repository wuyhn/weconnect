package com.example.weconnect.presentation.notification;
...
import com.example.weconnect.presentation.social.pending.PendingListActivity;
...
import com.example.weconnect.data.repository.FakeNotificationRepository;
import com.example.weconnect.data.repository.FakeNotificationRepository.NotificationType;
...
public class NotificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void bindRealNotification(NotifViewHolder holder, NotificationItem item) {
        ...
        if (isActionable && !item.isActioned()) {
            ...
            if (item.getType() == NotificationItem.NotificationType.JOIN_REQUEST
                ...
                postApi.getPost(item.getRelatedPostId()).enqueue(new Callback<ApiResponse<com.example.weconnect.data.model.PostResponse>>() {
                    @Override
                    public void onResponse(Call<ApiResponse<com.example.weconnect.data.model.PostResponse>> call,
                                           Response<ApiResponse<com.example.weconnect.data.model.PostResponse>> response) {
                        if (response.isSuccessful() && response.body() != null
                                && response.body().getResult() != null) {
                            com.example.weconnect.data.model.PostResponse post = response.body().getResult();
                            if (post.isExpired()) {
                    ...
                    @Override
                    public void onFailure(Call<ApiResponse<com.example.weconnect.data.model.PostResponse>> call, Throwable t) {
                        // Cannot check, show actions normally
                        showJoinRequestActions(holder, item);
                    }
                });
                ...
                if (item.getType() == NotificationItem.NotificationType.FRIEND_REQUEST_RECEIVED
                    ...
                    com.example.weconnect.data.network.FriendApiService friendApi =
                            RetrofitClient.getClient().create(com.example.weconnect.data.network.FriendApiService.class);
    ...
    private void navigateToPostDetail(NotificationItem item) {
        ...
        com.example.weconnect.data.network.PostApiService postApi =
                RetrofitClient.getClient().create(com.example.weconnect.data.network.PostApiService.class);
        ...
        postApi.getPost(item.getRelatedPostId()).enqueue(new Callback<ApiResponse<com.example.weconnect.data.model.PostResponse>>() {
            ...
            public void onResponse(Call<ApiResponse<com.example.weconnect.data.model.PostResponse>> call,
                ...
                if (response.isSuccessful() && response.body() != null
                        && response.body().getResult() != null) {
                    com.example.weconnect.data.model.Post post = response.body().getResult().toPost();
                    ...
                    Intent intent = new Intent(context, com.example.weconnect.presentation.post.detail.PostDetailActivity.class);
