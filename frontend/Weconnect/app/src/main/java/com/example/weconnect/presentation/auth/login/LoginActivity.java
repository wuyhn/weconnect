package com.example.weconnect.presentation.auth.login;
...
import com.example.weconnect.data.network.AuthApiService;
...
import com.example.weconnect.presentation.auth.register.RegisterActivity;
import com.example.weconnect.presentation.auth.forgotpassword.ForgotPasswordActivity;
        ...
        apiService.login(loginRequest).enqueue(new Callback<ApiResponse<AuthResponse>>() {
            ...
            public void onResponse(Call<ApiResponse<AuthResponse>> call,
                ...
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                    ...
                    FakeChatRepository.resetInstance();
                    FakePostRepository.resetInstance();
                    FakeSocialRepository.resetInstance();
                    FakeNotificationRepository.resetInstance();
                    // Set username cho fake repos
                    FakePostRepository.getInstance()
                            .setCurrentUsername(authResult.getFullName());
                    FakeSocialRepository.getInstance()
                            .setCurrentUsername(authResult.getFullName());
