package com.example.weconnect.presentation.profile.view;
...
import com.example.weconnect.presentation.post.adapter.PostAdapter;
import com.example.weconnect.presentation.social.adapter.UserReviewAdapter;
import com.example.weconnect.data.network.PostApiService;
import com.example.weconnect.data.network.ReviewApiService;
import com.example.weconnect.core.RetrofitClient;
import com.example.weconnect.data.repository.FakePostRepository;
import com.example.weconnect.data.repository.FakeSocialRepository;
import com.example.weconnect.core.ApiResponse;
import com.example.weconnect.data.model.UserProfile;
import com.example.weconnect.data.model.Post;
import com.example.weconnect.data.model.PostResponse;
import com.example.weconnect.data.model.UserReview;
import com.example.weconnect.presentation.main.MainActivity;
import com.example.weconnect.presentation.chat.list.ChatListActivity;
import com.example.weconnect.presentation.notification.NotificationsActivity;
import com.example.weconnect.presentation.profile.edit.EditProfileActivity;
import com.example.weconnect.presentation.auth.changepassword.ChangePasswordActivity;
import com.example.weconnect.presentation.post.archive.ArchivePostsActivity;
import com.example.weconnect.presentation.post.create.CreatePostActivity;
import com.example.weconnect.presentation.chat.conversation.ConversationActivity;
import com.example.weconnect.presentation.social.blocked.BlockedUsersActivity;
import com.example.weconnect.presentation.legal.LegalActivity;
import com.example.weconnect.presentation.auth.login.LoginActivity;
import com.example.weconnect.data.network.UserApiService;
import com.example.weconnect.data.network.FriendApiService;
import com.example.weconnect.data.network.ReportApiService;
...
public class UserProfileActivity extends AppCompatActivity {
    ...
    private com.example.weconnect.data.network.FriendApiService friendApiService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friendApiService = RetrofitClient.getClient().create(com.example.weconnect.data.network.FriendApiService.class);
        ...
        menuLogout.setOnClickListener(v -> {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Đăng xuất", (d, w) -> {
                        ...
                        com.example.weconnect.data.repository.FakePostRepository.resetInstance();
                        com.example.weconnect.data.repository.FakeChatRepository.resetInstance();
                        com.example.weconnect.data.repository.FakeNotificationRepository.resetInstance();
    ...
    private void showDeleteAccountDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Xoá", (dialog, which) -> {
                    RetrofitClient.loadToken(this);
                    com.example.weconnect.data.network.UserApiService userApi =
                            RetrofitClient.getClient().create(com.example.weconnect.data.network.UserApiService.class);
    ...
    private void loadInterestsFromBackend() {
        com.example.weconnect.core.RetrofitClient.loadToken(this);
        String token = com.example.weconnect.core.RetrofitClient.getAuthToken();
        ...
        com.example.weconnect.data.network.UserApiService apiService = 
                com.example.weconnect.core.RetrofitClient.getClient()
                        .create(com.example.weconnect.data.network.UserApiService.class);

        // Determine if viewing own profile or someone else's
        boolean isOwnProfile = socialRepository.getCurrentUsername().equalsIgnoreCase(username);

        if (isOwnProfile) {
            apiService.getInterests().enqueue(new retrofit2.Callback<com.example.weconnect.core.ApiResponse<java.util.List<String>>>() {
                @Override
                public void onResponse(retrofit2.Call<com.example.weconnect.core.ApiResponse<java.util.List<String>>> call,
                                       retrofit2.Response<com.example.weconnect.core.ApiResponse<java.util.List<String>>> response) {
                    if (response.isSuccessful() && response.body() != null
                            && response.body().getResult() != null) {
                ...
                @Override
                public void onFailure(retrofit2.Call<com.example.weconnect.core.ApiResponse<java.util.List<String>>> call, Throwable t) {
                    loadInterestsFromLocal();
                }
            });
        } else {
            ...
            long targetUserId = getIntent().getLongExtra("user_id", -1);
            if (targetUserId > 0) {
                apiService.getUserProfile(targetUserId).enqueue(new retrofit2.Callback<com.example.weconnect.core.ApiResponse<java.util.Map<String, Object>>>() {
                    @Override
                    public void onResponse(retrofit2.Call<com.example.weconnect.core.ApiResponse<java.util.Map<String, Object>>> call,
                                           retrofit2.Response<com.example.weconnect.core.ApiResponse<java.util.Map<String, Object>>> response) {
                        if (response.isSuccessful() && response.body() != null
                                && response.body().getResult() != null) {
                            java.util.Map<String, Object> profile = response.body().getResult();
                            String interestTags = profile.get("interestTags") != null
                    ...
                    @Override
                    public void onFailure(retrofit2.Call<com.example.weconnect.core.ApiResponse<java.util.Map<String, Object>>> call, Throwable t) {
                        loadInterestsFromLocal();
                    }
                });
            } else {
    ...
    private void updatePostViaApi(long postId, Intent data) {
        ...
        RetrofitClient.loadToken(this);
        PostApiService postApi =
                RetrofitClient.getClient().create(PostApiService.class);
        postApi.updatePost(postId, body).enqueue(new Callback<ApiResponse<PostResponse>>() {
            @Override
            public void onResponse(Call<ApiResponse<PostResponse>> call,
                                   Response<ApiResponse<PostResponse>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
